...
class MainHandler(webapp2.RequestHandler):
    def get(self):
    	...
    	lucky_numbers=[str(number) for number in range(1,100)]
        number_sentence='Your lucky number:'+"<strong>"+random.choice(lucky_numbers)+"</strong>"
        number_paragraph="<p>"+number_sentence+"</p>"
        cookie_again_button="<a href='.''><button>Another cookie plzzz!</button></a>"
